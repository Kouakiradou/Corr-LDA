...
alpha, BETA, Mean, Covariances, PHI, LAMBDA, GAMMA = M_step_Vectorization(images=new_image, captions=captions,k=10,tol=1e-3,tol_estep=1e-3,max_iter=100,initial_alpha_shape=100,initial_alpha_scale=0.01)
